...
async def set_pmlog(event):
    ...
    if input_str == "ايقاف":
        if gvarstatus("restartupdate") is None:
            return await edit_delete(event, "**⌔𖢿 تم تعطيل التحديثات بالفعل 𓆰️**")
        delgvar("restartupdate")
        return await edit_or_reply(event, "**⌔𖢿 تم تعطيل التحديثات بنجاح 𓆰**")
    if gvarstatus("restartupdate") is None:
        addgvar("restartupdate", "turn-oned")
        return await edit_or_reply(event, "**⌔𖢿 تم تشغيل التحديثات بنجاح 𓆰**")
    await edit_delete(event, "**⌔𖢿 تم تشغيل التحديثات بالفعل 𓆰️**")
