...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\n**𖢿
 هـذه هي قائمة اوامـر سـورس حيــاه **\n\n𖢿
 `.الامر1` ◂ اوامر الأدمن\n𖢿
...
async def hi(event):
 ...
 اكتب الامر مع اسم محافظتك او مدينتك بالانكليزي لعرض اوقات الصلاة والامساك\n\n ◂  `.تغميق`\n| : 𖢿
...
async def ae(event):
 ...
 قائمة اوامر بنك سورس حيــاه\n\n𖢿
 لأنشاء حساب بنكي\n𖢿
 اكتب(`.انشاء حساب بنك حيــاه`)\n\n① (`.استثمار` + المبلغ) \n◂ مثال :(`.استثمار 100`)\n② (`.حظ` + المبلغ)\n◂ مثال : (`.حظ 100`)\n③ (`.راتب`)\n④ (`.كنز`)\n⑤ (`.بخشيش`)\n⑥ (`.فلوسي`) | لرؤية فلوسك\n⑦ (`.بنكي` او `.مصرفي`) | برؤية حسابك\n⑧ (`.مسح حسابي`) | لحذف حسابك البنكي\n\n𖢿
 قائمة اوامر خطوط سورس حيــاه\n\n𖢿
 لتفعيل الخط الغامق\n𖢿
 اكتب (`.خط الغامق`)\n𖢿
...
async def ae(event):
 ...
 اكتب (`.الصيد`) \n\n𖢿
 لعرض العاب الاونلاين لسورس حيــاه\n𖢿
...
async def ae(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\n𖢿
 قائمة تحديثات سورس حيــاه\n\n𖢿
اوامر عمل حساب gmail وهمي\n𖢿
 اكتب ◂ `.ايميل وهمي` \n\n𖢿
 تيلثون حيــاه الذكاء الاصطناعي\n𖢿
 اكتب (`.os` + اي شئ تريدة)\n𖢿
 مثال ◂ `.os كم عدد سكان العراق`\n\n𖢿
 سورس حيــاه اختراق كود تيرمكس\n𖢿
 اكتب (`.هاك`)\n\n𖢿
 سورس حيــاه فحص فيزات\n𖢿
 لجلب فيز اكتب ◂ (`.فيزا`)\n𖢿
