...
async def variable(var):
    ...
    if vra is None:
        return await edit_delete(
            var, "**⌔𖢿 يجب عليك الرد على النص او الرابط حسب الفار الذي تضيفه **"
        )
    exe = var.pattern_match.group(1)
    await edit_or_reply(var, "**⌔𖢿 جارِ وضع الفار انتظر قليلا**")
    ...
    if exe == "رمز الاسم":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار رمز الاسم\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
    ...
    if exe == "المكرر":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار اسم امر مكرر\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار اسم مكرر \n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        heroku_var[variable] = vra
    ...
    if exe == "زخرفة الارقام" or exe == "زخرفه الارقام":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار زخرفه الارقام\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
    ...
    if exe == "اسم" or exe == "الاسم":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار اسم المستخدم\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
    ...
    if exe == "كروب التخزين":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار كروب التخزين\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
    ...
    if exe == "كروب الحفظ":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار كروب الحفظ\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
    ...
    if exe == "كليشة الفحص" or exe == "كليشه الفحص":
        ...
        if gvarstatus("ALIVE_TEMPLATE") is None:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار كليشة الفحص\n\n❃ جار اعادة تشغيل السورس انتظر دقيقة ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
    ...
    if (
        ...
        if gvarstatus("pmpermit_txt") is None:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار كليشة الحماية\n\n❃ جار اعادة تشغيل السورس انتظر دقيقة ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
    ...
    if exe == "كليشة الحظر" or exe == "كليشه الحظر":
        ...
        if gvarstatus("pmblock") is None:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار كليشة الحظر\n\n❃ جار اعادة تشغيل السورس انتظر دقيقة ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
    ...
    if exe == "ايموجي الفحص":
        ...
        if gvarstatus("ALIVE_EMOJI") is None:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار ايموجي الفحص\n\n❃ جار اعادة تشغيل السورس انتظر دقيقة ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
    ...
    if exe == "عدد التحذيرات":
        ...
        if gvarstatus("MAX_FLOOD_IN_PMS") is None:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار عدد التحذيرات\n\n❃ جار اعادة تشغيل السورس انتظر دقيقة ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
    ...
    if (
        ...
        if gvarstatus("pmpermit_pic") is None:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير فار صورة الحماية\n\n❃ جار اعادة تشغيل السورس انتظر دقيقة ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
...
async def variable(event):
    ...
    exe = event.text[5:]
    heroku_var = app.config()
    await edit_or_reply(event, "**⌔𖢿 جارِ حذف الفار انتظر قليلا**")
    if exe == "رمز الاسم":
        variable = "TIME_JM"
        await asyncio.sleep(1)
        if variable not in heroku_var:
            return await edit_or_reply(
                event, "**⌔𖢿 لم تتم اضافه فار رمز الاسم بالاصل.**"
            )
        await edit_or_reply(
            event,
            "**⌔𖢿 تم بنجاح حذف فار كروب الحفظ\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
        )
    ...
    if exe == "البايو" or exe == "النبذة":
        ...
        await asyncio.sleep(1)
        if variable not in heroku_var:
            return await edit_or_reply(event, "**⌔𖢿 لم تتم اضافه فار البايو بالاصل.**")
        await edit_or_reply(
            event,
            "**⌔𖢿 تم بنجاح حذف فار البايو\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
        )
        del heroku_var[variable]
    if exe == "الصورة" or exe == "الصوره":
        ...
        await asyncio.sleep(1)
        if variable not in heroku_var:
            return await edit_or_reply(event, "**⌔𖢿 لم تتم اضافه فار الصورة بالاصل.**")
        await edit_or_reply(
            event,
            "**⌔𖢿 تم بنجاح حذف فار الصورة\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
        )
        del heroku_var[variable]
    if exe == "كليشة الفحص" or exe == "كليشه الفحص":
        await asyncio.sleep(1)
        ...
        await edit_or_reply(
            event,
            "**⌔𖢿 تم بنجاح حذف فار كليشة الفحص\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
        )
    ...
    if exe == "كليشة الحماية" or exe == "كليشه الحماية":
        ...
        await edit_or_reply(
            event,
            "**⌔𖢿 تم بنجاح حذف فار كليشة الحماية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
        )
    ...
    if exe == "كليشة الحظر" or exe == "كليشه الحظر":
        ...
        await edit_or_reply(
            event,
            "**⌔𖢿 تم بنجاح حذف فار كليشة الحظر\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
        )
        delgvar("pmblock")
    if exe == "ايموجي الفحص":
        await asyncio.sleep(1)
    ...
    if exe == "عدد التحذيرات":
        ...
        await edit_or_reply(
            event,
            "**⌔𖢿 تم بنجاح حذف فار عدد التحذيرات\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
        )
    ...
    if exe == "اسم" or exe == "الاسم":
        ...
        await asyncio.sleep(1)
        if variable not in heroku_var:
            return await edit_or_reply(event, "**⌔𖢿 لم تتم اضافه فار الاسم بالاصل.**")
        await edit_or_reply(
            event,
            "**⌔𖢿 تم بنجاح حذف فار الاسم\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
        )
        del heroku_var[variable]
    if exe == "زخرفة الارقام" or exe == "زخرفه الارقام":
        variable = "TI_FN"
        ...
        if variable not in heroku_var:
            return await edit_or_reply(
                event, "**⌔𖢿 لم تتم اضافه فار زخرفه الارقام بالاصل.**"
            )
        await edit_or_reply(
            event,
            "**⌔𖢿 تم بنجاح حذف فار زخرفه الارقام\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
        )
        del heroku_var[variable]
    if exe == "كروب التخزين":
        variable = "PM_LOGGER_GROUP_ID"
        ...
        if variable not in heroku_var:
            return await edit_or_reply(
                event, "**⌔𖢿 لم تتم اضافه فار كروب التخزين بالاصل.**"
            )
        await edit_or_reply(
            event,
            "**⌔𖢿 تم بنجاح حذف فار كروب التخزين\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
        )
        del heroku_var[variable]
    if exe == "كروب الحفظ":
        variable = "PRIVATE_GROUP_BOT_API_ID"
        ...
        if variable not in heroku_var:
            return await edit_or_reply(
                event, "**⌔𖢿 لم تتم اضافه فار كروب الحفظ بالاصل.**"
            )
        await edit_or_reply(
            event,
            "**⌔𖢿 تم بنجاح حذف فار كروب الحفظ\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
...
async def variable(event):
    ...
    Syria = "Asia/Damascus"
    heroku_var = app.config()
    await edit_or_reply(event, "⌔𖢿 يتم جلب معلومات هذا الفار")
    if exe == "العراق" or exe == "عراق":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                event,
                "**⌔𖢿 تم بنجاح تغيير الوقت الى العراق\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                event,
    ...
    if exe == "السعودية" or exe == "السعوديه":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                event,
                "**⌔𖢿 تم بنجاح تغيير الوقت الى السعودية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                event,
    ...
    if exe == "مصر":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                event,
                "**⌔𖢿 تم بنجاح تغيير الوقت الى مصر\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                event,
    ...
    if exe == "الاردن":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                event,
                "**⌔𖢿 تم بنجاح تغيير الوقت الى الاردن\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                event,
    ...
    if exe == "اليمن":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                event,
                "**⌔𖢿 تم بنجاح تغيير الوقت الى اليمن\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                event,
...
async def variable(var):
    ...
    if exe == "1":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                var,
                "**⌔𖢿 تم بنجاح تغيير زخرفة الاسم الوقتي الخاص بك\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
