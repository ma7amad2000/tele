...
@sbb_b.on(admin_cmd(pattern="(تجميع تيربو|تجميع توربو)"))
async def _(event):
    if tepthon[0] == "yes":
        ...
        await sbb_b.send_message('@TURBO7xbot', '/start')
        await asyncio.sleep(5)
        msg0 = await sbb_b.get_messages('@TURBO7xbot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await sbb_b.get_messages('@TURBO7xbot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await sbb_b.get_messages('@TURBO7xbot', limit=1)
