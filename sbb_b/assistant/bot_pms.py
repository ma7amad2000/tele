...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("𓏺 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼", "https://t.me/HL_BG"),
                Button.url(
                    "•|𓆩˹𓏺َِ 𓏺ُِꪝَِꫝُِᎥَِ᥉ُِƙَُِِ꧖ُِꪗ   ›",
                    "https://t.me/BP_BP",
                ),
            )
        ]
        ...
        buttons = [
            [
                Button.url("• السورس •", "https://t.me/HL_BG"),
            ],
            [
