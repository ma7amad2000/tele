...
👋  {me.first_name} مرحبًا
 ⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼⦔ ♢━⊶⌯⩺
𖢿 لأنشاء حساب اختر احد المصاريف الاتية

𖢿 انشاء حساب بنك حياه 
...
𖢿 قائمة اوامر بنك سورس حياه

𖢿 لأنشاء حساب بنكي
𖢿 اكتب(`.انشاء حساب بنك حياه`)
...
async def bankar(message):
    ...
    if input == "بنك الجمهوريه ":
        bankn = "بنك الجمهوريه"
    elif input == "الوحده":
    	bankn = "مصرف الوحده"
    elif input != "الوحده" or "بنك الجمهوريه ":
