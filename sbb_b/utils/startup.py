...
LOGS = logging.getLogger("اعداد حياه")
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        descript = "⪼ هذه هي مجموعه الحفظ الخاصه بك اذا اردت فحذفها نهائيا @HL_B."
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(
            "تخزين رسائل حياه", sbb_b, Config.TG_BOT_USERNAME, descript, photobt
        )
