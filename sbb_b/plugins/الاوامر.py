...
async def hi(event):
    await edit_or_reply(
        event,
        "**قائـمه اوامر الادمن :**\n◂  `.حظر` \n𖢿 لحظر الشخص في مجموعه بالرد عليه\n\n ◂  `.الصورة -حذف`\n𖢿 اكتب الامر في المجموعة لحذف صورتها\n\n ◂  `.الصورة -وضع`\n𖢿 بالرد على الصورة في المجموعة لوضعها صورة للكروب\n\n ◂  `.الغاء الحظر`\n𖢿 لالغاء حظر الشخص من المجموعه بالرد عليه\n\n ◂  `.كتم` \n𖢿 لكتم الشخص بالرد عليه او وضع معرفه مع الامر\n\n ◂  `.الغاء كتم`\n𖢿 لالغاء كتم الشخص بالرد عليه بالامر\n\n ◂  `.تثبيت` \n𖢿 بالرد على الرسالة لتثبيتها في المجموعة\n\n ◂  `.الغاء تثبيت` \n𖢿 لألغاء تثبيت الرسالة في المجموعة , اذا اردت الغاء تثبيت جميع الرسائل اكتب مع الامر الكل\n\n ◂  `.رفع مشرف`  < لقب > \n𖢿 بالرد ؏ المستخدم لرفعه مشرف يمكنك وضع لقب\n\n ◂  `.تنزيل مشرف` \n𖢿 بالرد ؏ المستخدم لتنزيله من المشرفين\n\n ◂  `.ارفع`\n𖢿 بالرد ؏ المستخدم لرفعه مشرف في جميع المجموعات \n\n ◂  `.نزل`\n𖢿 بالرد ؏ المستخدم لتنزيله من جميع المجموعات\n\n ◂  `.الاحداث`\n𖢿 فقط ارسل الامر لعرض اخر احداث المجموعه \n\n ◂  `.الغاء المحظورين`\n𖢿 لالغاء جميع المحظورين في المجموعه فقط اكتب الامر\n\n ◂  `.المحذوفين`\n𖢿 لعرض الحسابات المحذوفة في المجموعه فقط اكتب الامر\n\n ◂  `.تفليش`\n𖢿 لحظر جميع المستخدمين من المجموعه فقط اكتب الامر\n\n ◂  `.تنزيل الكل`\n𖢿 لتنزيل جميع المشرفين من المجموعه فقط ارسل الامر في المجموعه\n\n ◂  `.المحظورين`\n𖢿 لعرض المستخدمين المحظورين في المجموعه اكتب الامر فقط\n\n ◂  `.تحذير`\n𖢿 بالرد على المستخدم لتحذيره في المجموعه \n\n ◂  `.حذف التحذيرات`\nلحذف تحذيرات المستخدم بالرد عليه او وضع معرفه مع الامر\n\n ◂  `.التحذيرات`\n𖢿 بالرد على المستخدم لعرض عدد تحذيراته",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nقائمـه اوامر المجموعة :\n\n ◂  `.المشرفين` \n𖢿 فقط اكتب الامر في المجموعه لعرض مشرفين المجموعه\n\n ◂  `.البوتات` \n𖢿 فقط اكتب الامر في الدردشة لعرض البوتات المضافة \n\n ◂  `.الاعضاء`\n𖢿 فقط اكتب الامر في المجموعه لعرض أعضاء الدردشة\n\n ◂  `.معلومات`\n𖢿 لعرض معلومات المجموعه اكتبه الامر في المجموعة\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nقائمـه اوامر الترحيب :\n\n ◂  `.ترحيب`\n𖢿 اكتب الامر مع الترحيب ليقوم بالترحيب في المستخدمين الجدد في المجموعة\n\n ◂  `.الترحيب`\n𖢿 لعرض رساله الترحيب الحاليه اكتب الامر فقط\n\n ◂  `.حذف الترحيب`\n𖢿 لالغاء الترحيب في المستخدمين فقط اكتب الامر\n\n⌔∮ متغيرات الترحيب [اضغط هنا](t.me/HL_BGEE_74)\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
        link_preview=False,
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nقائمـه اوامر الردود :\n\n ◂  `.رد`\n𖢿 يستخدم الأمر بإضافة رد في المجموعه اكتب الامر والرد الخاص بك بالرد على الكلمه \n\n ◂  `.حذف الردود`\n𖢿 فقط اكتب الامر في الدردشه لحذف جميع الردود المضافه\n\n ◂  `.الردود`\n𖢿 لعرض الردود المصافه فقط اكتب الامر\n\n ◂  `.ايقاف`\n𖢿 اكتب الامر مع الرد لحذف الرد من الدردشه\n\n⌔∮ شرح توضيحي عن اوامر الردود  [اضغط هنا](https://graph.org/اوامر-جمثون-04-24)\n⌔∮ شرح عن متغيرات الردود  [اضغط هنا](https://t.me/HL_BG)\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
        link_preview=False,
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nقائمـه اوامر حماية الخاص :\n\n ◂  `.الحماية تشغيل`\n𖢿 لتشغيل امر الحمايه يستخدم لتحذير المستخدمين عند مراسلتك في الخاص من التكرار\n\n ◂  `.الحماية تعطيل`\n𖢿 لتعطيل امر الحمايه وعدم تحذير المستخدمين في الخاص\n\n ◂  `.سماح` او `.س`\n𖢿 يستخدم الامر لقبول الشخص في الخاص وعدم ارسال تحذيرات له بالرد على الشخص\n\n ◂  `.رفض` او `.ر`\n𖢿 يستخدم لرفض الشخص من الخاص وتحذيره اذا كرر الرسائل وبعدها حظره\n\n ◂  `.بلوك`\n𖢿 بالرد على المستخدم لحظره من الخاص\n\n ◂  `.انبلوك`\n𖢿 بالرد على المستخدم لالغاء حظره من الخاص\n\n ◂  `.المسموح لهم`\n𖢿 اكتب الامر فقط لعرض معلومات عن الاشخاص الذين قبلته في الخاص\n\n⌔∮ لعرض فارات الحماية ارسل `.الفارات`\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
        link_preview=False,
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nقائمـه اوامر الكشف والاذاعة  :\n\n ◂  `.ايدي`\n𖢿 بالرد على المستخدم او وضع معرفه مع الامر لعرض معلوماته\n\n ◂  `.كشف`\n𖢿 بالرد على المستخدم لعرض معلومات معينه عنه\n\n ◂  `.للخاص`\n𖢿 اكتب الامر بالرد على رساله او اي ميديا ليقوم بارساله لجميع المحادثات في الخاص\n\n ◂  `.للكروبات`\n𖢿 بالرد على نص او اي ميديا ليقوم بنشره في جمبع المجموعات\n\n⌔∮ متغيرات الايدي  [اضغط هنا](https://t.me/HL_BG)\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
        link_preview=False,
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nقائمـه اوامر البوت :\n\n ◂  `.فحص`\n𖢿 فقط اكتب الامر لعرض معلومات السورس\n\n ◂  `.بنك`\n𖢿 فقط اكتب الامر لعرض سرعه البوت\n\n ◂  `.الانترنت + الاضافه`\n𖢿 يستخدم الامر لقياس سرعه البوت اكتب الامر مع الاضافه  :  `.الانترنت صورة`  `.الانترنت نص`\n\n ◂  `.اعادة تشغيل`\n𖢿 لعمل اعادة تشغيل للسورس وتحديثه \n\n ◂  `.الاشعارات` + تشغيل/تعطيل\n𖢿 لتشغيل او تعطيل الاشعارات عند تحديث او اعادة تشغيل السورس\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nقائمـه اوامر التلكراف و النطق :\n\n ◂  `.انطق`\n𖢿 بالرد على الكلام لتسجيله ببصمه و ارساله لك\n\n ◂  `.تلكراف ميديا ◂  \n𖢿 بالرد على الميديا لصنع رابط تلكراف منها\n\n ◂  `.تلكراف نص`\n𖢿 بالرد على النص لعمل رابط تلكراف\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 ??𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nقائمـه اوامر التحميل :\n\n ◂  `.متحركات`\n𖢿 بكتابة عنوان مع الامر لجلب متحركة لك من العنوان\n\n ◂  `.فلم`\n𖢿 بكتابة اسم الفلم باللغة الانجليزية مع الامر لعرض معلومات الفلم\n\n ◂  `.تحميل فيديو`\n𖢿 بالرد على رابط من يوتيوب او اي موقع ثاني لتحميل الفيديو وارساله لك\n\n ◂  `.تحميل صوتي`\n𖢿 اكتب الامر بالرد على الرابط من اليوتيوب لتكميل مقطع الصوتي و ارساله لك\n\n ◂  `.انستا`\n𖢿 اكتب الامر بالرد على الرابط التحميل من الانستا \n\n ◂  `.بينترست`\n𖢿 بالرد على رابط من بينتسرت للتحميل لك\n\n ◂  `.صور`\n𖢿 اكتب الامر مع عنوان للبحث عنه وارسال لك الصور،  اذا بحثت عن اباحي سيتم تعطيل حسابك\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\n** قائـمه اوامر التكرار**:\n\n◂ `.كرر`\n𖢿 اكتب الامر مع عدد التكرار بالرد ؏ النص او او صورة ملصق ليقوم بتكراره مع العدد الذي وضعته\n\n ◂  `.تكرار الملصق` \n𖢿 بالرد على الملصق ليقوم باستخراج جميع ملصقات الحزمه وارسالها في الدردشة\n\n ◂ `.مكرر`\n𖢿 اكتب الامر مع وقت بالثواني و مع عدد التكرار وبالرد على صورة او نص  (  تكرار وقتي  )\n\n ◂  `.التكرار`\n𖢿 بالرد على الرسالة بالامر فقط سيقوم بعمل تكرار سريع ويصل عدده الى 10 الاف تكرار  ! \n\n ◂  `.ايقاف التكرار`\n𖢿 يقوم هذا الامر بأيقاف التكرار فقط اكتبه\n\n** تنبيه اوامر التكرار قد تؤدي الى حظر حسابك على التلي اذا استخدمتها بشكل غير صحيح**\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\n** قائـمه اوامر الأنتحال و التقليد :**\n\n ◂  `.انتحال`\n𖢿 بالرد على المستخدم لأنتحال حسابه  من اسم وصورة وبايو  . \n\n ◂  `.اعادة الحساب`\n𖢿 لأعادة حسابك الى وضعه السابق  .\n\n ◂ `.تقليد`\n𖢿 بالرد على الشخص لتقليد جميع رسائله في الدردشه \n\n ◂ `.الغاء تقليد`\n𖢿 بالرد على الشخص لايقاف التقليد\n\n ◂ `.المقلدهم `\n𖢿 لاظهار قائمه الاشخاص الذي فعلت عليهم امر التقليد ولمسحهم ارسل  `.حذف المقلدهم`\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nقائـمه اوامر الوقتي:**\n\n◂ `.اسم وقتي`\n𖢿 بكتابة الامر لاضافة اسم وقتي حسب منطقة التي وضعتها \n\n ◂ `.انهاء اسم وقتي`\n𖢿 لانهاء الاسم الوقتي و ارجاع الاسم الطبيعي .\n\n ◂ `.بايو وقتي`\n𖢿 بكتابة الامر لاضافة ساعه يتحرك مع النبذة الخاصة بك  \n\n ◂ `.انهاء بايو وقتي`\n𖢿 لانهاء البايو الوقتي و ارجاع البايو الطبيعي\n\n ◂  `.الصورة الوقتية`\n𖢿 لبدء تشغيل وقت على الصورة الخاصة بحسابك\n\n ◂  `.انهاء الصورة الوقتية`\n𖢿 لألغاء امر الصورة الوقتية\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nاوامر جلب الذاتية وامر الاضافة**:\n\n ◂  `.ضيف`\n𖢿 اكتب الامر مع رابط مجموعه التي تريد سحب اعضائها وارسل الامر في مجموعتك لسحبهم الى مجموعتك\n\n ◂ `.ذاتيه` او `.ذاتية`\n𖢿 بالرد على صورة او فيديو ذاتية التدمير لحفظها وارسالها في الرسائل المحفوظة بسرية تامة الامر ل حيــاه حصريا!\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nقائـمه اوامر الأكسترا: \n\n ◂  `.فك المحظورين`\n𖢿 قم بكتابة الامر لفك جميع المستخدمين الذي حظرتهم من الخاص\n\n ◂  `.وهمي كتابه`\n𖢿 لبدء وضع كتابة بشكل وهمي جربه بنفسك\n\n ◂  `.وهمي فيديو`\n𖢿 لبدء وضع ارسال فيديو بشكل وهمي جربه بنفسك\n\n ◂  `.وهمي لعبه`\n𖢿 لبدء وضع ارسال لعبة بشكل وهمي جربه بنفسك\n\n ◂  `.وهمي صوتي`\n𖢿 لبدء وضع ارسال بصمة صوتية بشكل وهمي جربه بنفسك\n\n ◂  `.الحاسبة`\n𖢿 لعرض حاسبه علميه جربه بنفسك\n\n ◂  `.حالتي`\n𖢿 لعرض حاله حسابك الحاليه اذا كان محظور او لا\n\n ◂  `.صلاة`𖢿 اكتب الامر مع اسم محافظتك او مدينتك بالانكليزي لعرض اوقات الصلاة والامساك\n\n ◂  `.تغميق`\n𖢿 بالرد على الكلام لجعله بشكل غامق\n\n ◂  `.نسخ`\n𖢿 بالرد على الكلام لجعله بشكل للنسخ\n\n ◂  `.مائل`\n𖢿 بالرد على الكلام لجعله بشكل مائل\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nقائـمه اوامر التاك والملفات:\n\n ◂  او  `.تاك للكل`\n𖢿 لعمل تاك لاخر 100 عضو في المجموعه اكتب الامر مع اي نص تريد\n\n ◂  `.تبليغ`\n𖢿 لتبليغ المشرفين اذا حصل شيء ما فقط اكتب الامر\n\n ◂  `.منشن`\n𖢿 بالرد على المستخدم وكتابه شيء مع الامر لعمل تاك داخل الكلمه للمستخدم\n\n ◂  `.تنصيب`\n𖢿 لتنصيب ملفات خارجيه للسورس \n\n ◂  `.الغاء تنصيب`\n𖢿 بكتابه الامر مع اسم الملف لحذف تنصيبه من السورس\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
    )
...
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺\n\nقائـمه اوامر الصيغ:\n\n ◂  `.فاس`\n𖢿 بالرد على متحركو او فيديو لتحويله الى ملصق متحرك\n\n ◂  `.تحويل صورة`\n𖢿 بالرد على ملصق اتحويله الى صورة\n\n ◂  `.تحويل ملصق`\n𖢿 بالرد على الصورة لتحويلها الى ملصق\n\n ◂  `.تحويل متحركة `\n𖢿 بالرد على الفيديو لتحويله الى متحركة \n\n◂  `.لملف`\n𖢿 بكتابة اسم الملف والرد على كتابة لتحويلها الى ملف\n\n ◂  `.لكتابة`\n𖢿 بالرد على الملف لاستخراج النص الذي بداخله وارساله لك\n\n ◂  `.الملف لصورة`\n𖢿 بالرد على الصورة التي تكون بشكل ملف لتحويلها لصورة عادية\n\n ◂  `.تحويل بصمة`\n𖢿 بالرد على المقطع الوصتي لتحويله الى بصمة\n\n ◂  `.تحويل صوتي`\n𖢿 بالرد على البصمة لتحويلها على شكل مقطع صوتي\n⩹⌯⊷━♢ ⦓ 𓏺𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝘼𝙔𝘼 ⦔ ♢━⊶⌯⩺",
        link_preview=False,
    )
